...
def get_occluded_images(im_names, im_dir = '/home/ubuntu/Dataset/market1501/images'):
  ...
  :param im_names: List of names of images
  :param im_dir: directory of where the images are
  :return: list of occluded image arrays
  """
  occluded_dir = os.path.join ( im_dir, 'transformed' )
...
def global_loss(im_names, tri_loss, global_feat, labels, normalize_feature=True):
    """
  Args:
...
def local_loss(
  ...
  """
    ...
    if p_inds is None or n_inds is None:
        ...
        loss = tri_loss ( dist_ap, dist_an )
        return loss, dist_ap, dist_an, occluded_ims
