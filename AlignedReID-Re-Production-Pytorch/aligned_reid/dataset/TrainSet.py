...
if __name__ == "__main__":
    partitions = pickle.load(open('/Users/soutikchakraborty/Downloads/CS230Data/market1501/partitions.pkl', 'rb'))
    part = 'trainval'
    im_names = partitions['{}_im_names'.format (part)]
    ids2labels = partitions['trainval_ids2labels']
    instance = TrainSet (im_dir='/Users/soutikchakraborty/Downloads/CS230Data/market1501/images',
                         im_names=im_names,
                         ids2labels = ids2labels,
                         ids_per_batch=1,
                         ims_per_id=1)
    print ids2labels
    print instance.next_batch()
