...
def create_dataset(
        ...
        part='trainval',
        **kwargs):
    assert name in ['market1501', 'cuhk03', 'duke', 'combined', 'market1501_occluded', 'market1501_transformed'], \
    ...
    if name == 'market1501':
        ...
        im_dir = ospeu ( '~/Dataset/Combined/trainval_images/trainval_images' )
        partition_file = ospeu ( '~/Dataset/Combined/partitions.pkl' )
